...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * No description
     *
     * @name AuctionControllerCreateAuction
     ...
     * No description
     *
     * @name AuctionControllerUpdateAuction
     * @request PUT:/api/auctions/{id}
     */
    auctionControllerUpdateAuction: (id: number, data: UpdateAuctionDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/auctions/${id}`,
        method: "PUT",
        body: data,
     ...
     * No description
     *
     * @name AuctionControllerDeleteAuction
     * @request DELETE:/api/auctions/{id}
     */
    auctionControllerDeleteAuction: (id: number, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/auctions/${id}`,
        method: "DELETE",
        ...params,
